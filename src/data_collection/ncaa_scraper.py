...
url_team_map = {"Baylor" : "https://stats.ncaa.org/teams/481920", 
...
for team_name, root_url in url_team_map.items():
    ...
    game_by_game_url = "https://stats.ncaa.org" + str(soup.find('body').find('div', id='contentarea').contents[17]["href"])
